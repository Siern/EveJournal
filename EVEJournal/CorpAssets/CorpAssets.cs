...
namespace EVEJournal
{
    partial class CorpAssets : IDBRecord
    {
        ...
        public static readonly string TableName = "CorpAssets";
        public static readonly long VersionNumber = 2;

        CorpAssetsObjectInternal m_DataObject = 
            new CorpAssetsObjectInternal();
        ...
        public CorpAssets(SQLiteDataReader reader)
        {
        ...
        public CorpAssets(string aCharID, XmlNode xmlNode)
        {
        ...
        public CorpAssets(CorpAssetsObject obj)
        {
            m_DataObject = (CorpAssetsObjectInternal)obj;
        }
    }
}
